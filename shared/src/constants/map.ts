...
export const MAP_SPAWNS: Record<TeamId, Vector3[]> = {
  CT: [
    { x: -30, y: 0, z: -21 },
    { x: -27, y: 0, z: -22 },
    { x: -24, y: 0, z: -21 },
...
export const MAP_DEATHMATCH_SPAWNS: Vector3[] = [
  { x: -30, y: 0, z: -21 },
  { x: -15, y: 0, z: -23 },
  { x: 0, y: 0, z: -24 },
  { x: 13, y: 0, z: -22 },
...
export const MAP_COLLIDERS: MapCollider[] = [
...
export const MAP_NAV_POINTS: SharedNavPoint[] = [
